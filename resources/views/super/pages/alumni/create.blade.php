        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <H4>Data Pribadi</H4>
                        <form method="POST" action="/super-alumni-asrama-store">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="id_regency"
                                            ...
                                            class="text-danger">
                                        <select name="id_regency" class="form-control {{ $errors->has('id_regency') ? ' is-invalid': '' }}" disabled>
                    ...
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <select name="type_organization" class="form-control">
                                <option value="O1">Kemahasiswaan</option>
                                <option value="O2">Kemasyarakatan</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="nama_penghargaan">Nama Organisasi</label>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('select[name="id_province"]').on('change', function() {
                $('select[name="id_regency"]').val("");
                var result = regency.filter((v) => v.province_id == this.value);
                if (result.length > 0) {
                    $('select[name="id_regency"]').html('<option value="">Pilih Kota/Kabupaten</option>');
                    $('select[name="id_regency"]').removeAttr("disabled");
                    result.forEach((val, i) => {
                        $('select[name="id_regency"]').append(`<option value="${val.id}">${val.name}</option>`)
                    });
                }
            });
